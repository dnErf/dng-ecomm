...
const routes = [
    ...
    {
        path: 'account',
        loadChildren: () => Promise.all(/*! import() | pages-account-account-module */[__webpack_require__.e("default~pages-account-account-module~pages-basket-basket-module~pages-shop-shop-module"), __webpack_require__.e("default~pages-account-account-module~pages-basket-basket-module"), __webpack_require__.e("pages-account-account-module")]).then(__webpack_require__.bind(null, /*! ./pages/account/account.module */ "./src/app/pages/account/account.module.ts")).then(m => m.AccountModule)
    },
    {
        path: 'basket',
        loadChildren: () => Promise.all(/*! import() | pages-basket-basket-module */[__webpack_require__.e("default~pages-account-account-module~pages-basket-basket-module~pages-shop-shop-module"), __webpack_require__.e("default~pages-account-account-module~pages-basket-basket-module"), __webpack_require__.e("pages-basket-basket-module")]).then(__webpack_require__.bind(null, /*! ./pages/basket/basket.module */ "./src/app/pages/basket/basket.module.ts")).then(m => m.BasketModule)
    },
    {
        path: 'shop',
        loadChildren: () => Promise.all(/*! import() | pages-shop-shop-module */[__webpack_require__.e("default~pages-account-account-module~pages-basket-basket-module~pages-shop-shop-module"), __webpack_require__.e("pages-shop-shop-module")]).then(__webpack_require__.bind(null, /*! ./pages/shop/shop.module */ "./src/app/pages/shop/shop.module.ts")).then(m => m.ShopModule),
...
/* harmony import */ var src_app_core_interceptors_jwt_interceptor__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! src/app/core/interceptors/jwt.interceptor */ "./src/app/core/interceptors/jwt.interceptor.ts");
/* harmony import */ var src_app_core_interceptors_loading_interceptor__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! src/app/core/interceptors/loading.interceptor */ "./src/app/core/interceptors/loading.interceptor.ts");
/* harmony import */ var src_app_components_not_found_component__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! src/app/components/not-found.component */ "./src/app/components/not-found.component.ts");
/* harmony import */ var src_app_core_services_product_service__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! src/app/core/services/product.service */ "./src/app/core/services/product.service.ts");
/* harmony import */ var src_app_components_server_error_component__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! src/app/components/server-error.component */ "./src/app/components/server-error.component.ts");
...
AppModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵdefineInjector"]({ factory: function AppModule_Factory(t) { return new (t || AppModule)(); }, providers: [
        ...
        { provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HTTP_INTERCEPTORS"], useClass: src_app_core_interceptors_jwt_interceptor__WEBPACK_IMPORTED_MODULE_14__["JwtInterceptor"], multi: true },
        { provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HTTP_INTERCEPTORS"], useClass: src_app_core_interceptors_loading_interceptor__WEBPACK_IMPORTED_MODULE_15__["LoadingInterceptor"], multi: true },
        ...
        src_app_core_services_product_service__WEBPACK_IMPORTED_MODULE_17__["ProductService"]
    ], imports: [[
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_5__["ɵɵsetNgModuleScope"](AppModule, { declarations: [_app_component__WEBPACK_IMPORTED_MODULE_9__["AppComponent"],
        src_app_components_not_found_component__WEBPACK_IMPORTED_MODULE_16__["NotFoundComponent"],
        src_app_components_server_error_component__WEBPACK_IMPORTED_MODULE_18__["ServerErrorComponent"],
...
function ServerErrorComponent_ng_container_3_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](6, "Stack Trace - ");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
...
ServerErrorComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: ServerErrorComponent, selectors: [["app-server-error"]], decls: 4, vars: 1, consts: [[1, "container", "mt-5"], [4, "ngIf"], [1, "text-danger"], [1, "font-weight-bold"], [1, "mt-5", 2, "background-color", "whitesmoke"]], template: function ServerErrorComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](3, ServerErrorComponent_ng_container_3_Template, 9, 2, "ng-container", 1);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
    } if (rf & 2) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](3);
